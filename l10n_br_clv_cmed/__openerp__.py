...
====
    ...
    'data': [
        ...
        'wkf/clv_cmed_workflow.xml',
        'wkf/clv_cmed_wkf_view.xml',
        'history/clv_cmed_history_view.xml',
        ...
        'cmed_list/clv_cmed_list_view.xml',
        'cmed_list/clv_cmed_list_item_view.xml',
        'menu/l10n_br_clv_cmed_menu_view.xml',
        ],
    'demo': [],
    'test': [],
    'init_xml': [],
